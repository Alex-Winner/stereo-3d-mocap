...
def run_mp(input_stream1, input_stream2, P0, P1):
    ...
    holistic0 = mp_holistic.Holistic(
        min_detection_confidence=0.5, min_tracking_confidence=0.5, model_complexity=1
    )
    holistic1 = mp_holistic.Holistic(
        min_detection_confidence=0.5, min_tracking_confidence=0.5, model_complexity=1
    )
    ...
    while True:
        ...
        results0 = holistic0.process(frame0)
        results1 = holistic1.process(frame1)
        ...
        if results0.pose_landmarks:
            for i, landmark in enumerate(results0.pose_landmarks.landmark):
                if i not in pose_keypoints:
                    continue  # only save keypoints that are indicated in face_keypoints
